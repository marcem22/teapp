<x-event-layout>
    ...
    <div class="max-w-7xl mx-auto p-6 bg-white shadow-md rounded-lg mt-4 roles-container">
        <h1 class="page-title text-2xl font-bold text-[#1E1E49] mb-4">{{ __('Gestión de Roles') }}</h1>
        ...
        <div class="overflow-x-auto">
            <table class="roles-table min-w-full bg-white border border-gray-300 rounded-lg mb-4">
                <thead class="bg-[#1E1E49] text-white">
                    <tr>
                        <th class="py-2 px-4 border-b text-left w-full">Nombre</th>
                        <th class="py-2 px-4 border-b text-left w-full">Acciones</th>
                    </tr>
                </thead>
                <tbody>
